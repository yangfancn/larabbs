        ...
        <form action="{{ route('topics.update', $topic->id) }}" method="POST" accept-charset="UTF-8">
          ...
          <form action="{{ route('topics.store') }}" method="POST" accept-charset="UTF-8">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="reply_count" id="reply_count-field"
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="last_reply_user_id" id="last_reply_user_id-field"
